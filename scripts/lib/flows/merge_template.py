...
from .. import template_diff, template_merge, template_version
...
def flow_merge_template(args: argparse.Namespace) -> int:
    ...
    if interactive:
        ...
        console.print("  (Feature not yet implemented - use --force to apply with conflicts)")
        return 1
    
    console.print("\n💡 Resolution options:", style="cyan")
    console.print("  --force        Apply merge with conflict markers (manual resolution)", style="cyan")
    console.print("  --interactive  Interactive conflict resolution (coming soon)", style="cyan")
