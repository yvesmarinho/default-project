...
```markdown
![Git Validation](https://github.com/{{ github_owner }}/{{ github_repo }}/workflows/Git%20Validation/badge.svg)
```
...
```markdown
![CI](https://github.com/{{ github_owner }}/{{ github_repo }}/workflows/CI/badge.svg)
![CD](https://github.com/{{ github_owner }}/{{ github_repo }}/workflows/CD/badge.svg)
```
